...
var imagePuzzle = {
    ...
    startGame: function (images, gridSize,temp) {
        this.setImage(images, gridSize, temp );
        $('#playPanel').show();
        $('#sortable').show();
        $('#stepBox').show();
        $('#timeBox').show();
    ...
    enableSwapping: function (elem) {
        ...
        $(elem).droppable({
            drop: function (event, ui) {
                ...
                {$('#actualImageBox').empty().html($('#gameOver').html());$('#sortable').hide() ;}
                else {
                    var now = new Date().getTime();
    ...
    setImage: function (images, gridSize,temp) {
